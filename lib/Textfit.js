...
exports.default = (0, _react.createClass)({
    ...
    propTypes: {
        children: _react.PropTypes.oneOfType([_react.PropTypes.array, _react.PropTypes.string, _react.PropTypes.func]),
    ...
    process: function process() {
        ...
        var forceSingleModeWidth = _props.forceSingleModeWidth;
        var perfectFit = _props.perfectFit;
        ...
        function (stepCallback) {
            ...
            (0, _whilst2.default)(function () {
                // Even if testPrimary() fails, stop if fontSize is going to be negative
                return !testPrimary() && mid > 0;
            }, function (whilstCallback) {
                if (shouldCancelProcess()) return whilstCallback(true);
    ...
    render: function render() {
        ...
        var props = _objectWithoutProperties(_props2, ['children', 'text', 'style', 'min', 'max', 'mode']);
